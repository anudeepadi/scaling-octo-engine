...
class FirebaseMessagingService {
  ...
  Future<void> setupMessaging() async {
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
      developer.log('A notification was tapped and opened the app!',
          name: 'FCM');
      developer.log('Message data: ${message.data}', name: 'FCM');
    ...
    if (initialMessage != null) {
      developer.log('App opened from terminated state by tapping notification',
          name: 'FCM');
      developer.log('Initial message data: ${initialMessage.data}',
          name: 'FCM');
  ...
  void _processMessage(RemoteMessage message) {
    try {
      ...
      // Check if this is a Quitxt message (compatible with expected format)
      if (data.containsKey('serverMessageId') &&
        ...
        developer.log(
            'Received FCM message with unexpected format: ${data.toString()}',
            name: 'FCM');
      }
    } catch (e) {
